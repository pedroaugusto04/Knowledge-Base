export const WHATSAPP_INTRO_MESSAGE = [
  ...
  '',
  '*AI Assistant*',
  'You can chat with me naturally to:',
  '- Capture and save new notes or ideas.',
  '- Create tasks and reminders for your projects.',
  '- Ask free questions.',
  '',
  '*Base Search*',
  '- To search for specific information in your base, send the command:',
  '  `/ask <your question>`',
  '  _Example: `/ask How does the refund policy work?`_',
  '',
...
export const TELEGRAM_INTRO_MESSAGE = [
  ...
  '',
  'Feel free to follow your reminders and notifications here!'
].join('\n');
