...
import { ConversationAgentGateway, type ConversationAgentRequest, type ConversationAgentResponse } from '../../application/ports/conversation-agent.gateway.js';
import type { RuntimeEnvironment } from '../../application/ports/runtime-environment.port.js';
